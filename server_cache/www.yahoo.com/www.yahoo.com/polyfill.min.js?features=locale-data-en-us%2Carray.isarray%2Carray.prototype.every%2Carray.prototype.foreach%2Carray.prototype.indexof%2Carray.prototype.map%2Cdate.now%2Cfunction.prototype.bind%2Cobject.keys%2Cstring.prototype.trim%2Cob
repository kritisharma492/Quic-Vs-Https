...
Via: http/1.1 a59.ue.bf1.yahoo.net (ApacheTrafficServer [cMsSfW]), https/1.1 e22.ycpi.nya.yahoo.com (ApacheTrafficServer [cMsSfW]), http/1.1 media-ncache-fp38.prod.media.bf1.yahoo.com (ApacheTrafficServer [cRs f ]), http/1.1 media-ncache-fp30.prod.media.bf1.yahoo.com (ApacheTrafficServer [cMsSf ]), http/1.1 media-router-fp1014.prod.media.bf1.yahoo.com (ApacheTrafficServer [cMsSfW])
Server: ATS
...
Content-Security-Policy: sandbox allow-forms allow-same-origin allow-scripts allow-popups allow-popups-to-escape-sandbox allow-presentation; report-uri https://csp.yahoo.com/beacon/csp?src=ats&site=frontpage&region=US&lang=en-US&device=desktop&yrid=0t58um9e0hsqv&partner=;
