HTTP/1.1 200 OK
X-Frame-Options: ALLOW-FROM https://www.yahoo.com/news
X-Powered-By: Express
X-Platform-Version: 2
Access-Control-Allow-Origin: *
Content-Type: application/javascript
Cache-Control: public, max-age=86400
ETag: "qFuS/886hFTJWg1qBFE7ChC8otmZwUBjLmhPKoTbCiA="
Vary: Accept-Encoding
Date: Thu, 06 Dec 2018 01:48:17 GMT
Age: 29535
Strict-Transport-Security: max-age=31536000
Via: http/1.1 a59.ue.bf1.yahoo.net (ApacheTrafficServer [cMsSfW]), https/1.1 e22.ycpi.nya.yahoo.com (ApacheTrafficServer [cMsSfW]), http/1.1 media-ncache-fp38.prod.media.bf1.yahoo.com (ApacheTrafficServer [cRs f ]), http/1.1 media-ncache-fp40.prod.media.bf1.yahoo.com (ApacheTrafficServer [cMsSf ]), http/1.1 media-router-fp1002.prod.media.bf1.yahoo.com (ApacheTrafficServer [cMsSfW])
Server: ATS
...
Content-Security-Policy: sandbox allow-forms allow-same-origin allow-scripts allow-popups allow-popups-to-escape-sandbox allow-presentation; report-uri https://csp.yahoo.com/beacon/csp?src=ats&site=frontpage&region=US&lang=en-US&device=desktop&yrid=2plh1c5e0hsq0&partner=;
